...
#!/usr/bin/env python3
"""RAVEN v3.1 — Python Engine (auto-generated by raven.sh)
...
import subprocess, argparse, os, re, base64, shutil, math, time, string
...
def main():
    print(f"{Fore.CYAN}{'='*55}\n   RAVEN v3.1 — CTF Multi-Category Toolkit\n{'='*55}{Style.RESET_ALL}")
    check_tool_availability()
    p=argparse.ArgumentParser(
        description="RAVEN v3.1 — CTF Multi-Category Toolkit",
